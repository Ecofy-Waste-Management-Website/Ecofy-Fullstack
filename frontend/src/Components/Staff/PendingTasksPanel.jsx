const PendingTasksPanel = ({
  ...
  <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_1.4fr] gap-4 min-h-[540px]">
    <div className="rounded-3xl border border-[#06a63e]/15 bg-[#eaf9ee]/60 p-4 shadow-sm flex flex-col">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <span className="rounded-full bg-white/80 px-3 py-1 text-xs font-black text-[#06a63e]">{pendingOrders.length} orders</span>
      </div>

      <div className="overflow-hidden rounded-2xl border border-[#06a63e]/10 bg-white/75 shadow-inner flex-1">
        ...
        <div className="max-h-[420px] overflow-y-auto">
          {pendingOrders.length === 0 ? (
            ...
            pendingOrders.map((order) => (
              <div key={order._id} className="grid grid-cols-[1.2fr_2fr_1fr_1fr] gap-3 border-b border-[#06a63e]/10 px-4 py-4 last:border-b-0 items-center">
                <div>
    ...
    <div className="rounded-3xl border border-[#06a63e]/15 bg-[#eaf9ee]/35 p-4 shadow-sm flex flex-col min-h-[540px] overflow-hidden">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <h3 className="text-lg font-black text-[#03652a]">Balangoda Map</h3>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#06a63e]/50">Center point for Balangoda, Sri Lanka</p>
        </div>
        <div className="rounded-full bg-white/80 px-3 py-1 text-xs font-black text-[#06a63e]">Map</div>
      </div>

      <div className="flex-1 overflow-hidden rounded-3xl border border-[#06a63e]/10 bg-white shadow-inner">
        <iframe
